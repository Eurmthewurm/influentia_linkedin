...
- A license key — start your 14-day free trial at **https://influentia.io**. Your license key will appear on the success page and will also be emailed to you — keep it handy.
...
Your browser opens at `http://localhost:5555`. On first launch you'll be asked to paste your license key — this is shown on the success page right after checkout and also sent to your email. After that, a setup wizard will appear.

## Step 3 — The wizard (first run)

The wizard has 5 short steps:

1. **Welcome** — read the heads-up about LinkedIn's terms of service.
2. **You** — your name, company, booking link (Calendly etc.), and what you want prospects to do ("book a quick call" is fine).
3. **What you sell** — a short paragraph about your offering. Be specific. Generic input = generic AI messages.
4. **Your story** — two short paragraphs: why you started, and how you talk. This shapes the AI's tone on every message.
5. **Connect LinkedIn** — click the button, a Chrome window opens, log into LinkedIn once. The session is saved locally so you never have to log in again.
...
### Bonus: Reddit Signals

The **Reddit Signals** tab surfaces posts from Reddit where people are actively looking for what you sell — before they search Google, before they contact a competitor. Each morning Influentia scans relevant subreddits and queues up up to 3 reply drafts for you to approve. This runs alongside your LinkedIn outreach automatically.
...
- **No API keys needed.** AI and search are handled by Influentia — you don't need to set up any third-party API accounts.
...
- Your 14-day trial starts when you enter your card on the landing page. After 14 days your card is charged $97/month. Cancel anytime from Settings → "Manage subscription" (opens the Stripe customer portal), or email support before day 14 and I'll cancel for you.
