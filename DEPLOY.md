...
5. Pricing model: **Recurring**
   Standard pricing: `$97.00 USD per month`
...
> **Pricing note:** The product is priced at $97/month (≈€89/month) with a 14-day money-back guarantee. The $29 figure in older versions of this doc was from an earlier pricing model — always use the current $97/mo pricing in Stripe.
...
6. **Option B (Live Test with Real Card):**
   ...
   - This will charge $97 to your card (you can refund via Stripe dashboard later)
